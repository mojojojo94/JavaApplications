...
public class GuessTheNumber {
    ...
    public void play(){
        ...
        while(true){
            ...
            if (move > theNUMBER){
                ...
                System.out.println("You're on the money! You got it!");
                break;
            }
        }
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Welcom to my guess the number game. Guess a number"
            + " 0 and a " + guessGame.maxNum + " inclusicve. Type a number " +
            "to get started.");
        guessGame.play();
